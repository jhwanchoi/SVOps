...
from app.domain.entities import User, Dataset, Task
from app.domain.value_objects import UserId, DatasetId, TaskId
from app.shared.types import TaskStatus, RecordingType
...
class DatasetRepository(ABC):
    ...
    @abstractmethod
    async def list_by_type(self, data_type: RecordingType, skip: int = 0, limit: int = 100) -> List[Dataset]:
        pass
    
    @abstractmethod
    async def list_by_creator(self, creator_id: UserId, skip: int = 0, limit: int = 100) -> List[Dataset]:
        pass
